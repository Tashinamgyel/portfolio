...
import { Github, Mail, Phone, MapPin, Download, Moon, Sun, Code, Zap, Trophy, Users, Smartphone, Database, Globe } from "lucide-react"
...
export default function Portfolio() {
  ...
  const projects = [
    {
      ...
      description:
        "Real-time dual-app ecosystem (Driver & User) integrating ESP32 hardware via MQTT and Firebase for live tracking.",
      tech: "Kotlin, Firebase, MQTT, IoT",
      date: "Dec 2025",
      highlight: "🚀 Full Stack IoT",
      icon: MapPin,
      color: "from-blue-500 to-cyan-400",
    },
    {
      title: "Constitution of Bhutan App",
      description:
        "Official government app published on Play Store. Features offline caching (Room DB) and full-text search.",
    ...
    {
      title: "BhutanAPI Services",
      description: "Centralized RESTful API delivering national data (statistics, GNH) to government agencies with 99% uptime.",
    ...
    {
      title: "House of Bhutan Platform",
      description: "Civic discussion platform simulating parliament. Features real-time debate threads and voting systems.",
      tech: "Kotlin, Firebase, MVVM, Hilt",
      date: "Nov 2025",
      icon: Users,
    ...
    },
    {
      ...
      description: "High-fidelity cross-platform MVP with complex multi-image upload flows and authentication.",
      tech: "Flutter, Dart, Spring Boot",
      date: "Sept 2025",
      icon: Smartphone,
      color: "from-pink-400 to-rose-500",
    },
    {
      title: "TeeTime - Golf Booking",
      description:
        "Flutter-based booking app with social engagement features. Finalist at Hospitality & ERP Hackathon.",
  ...
  const skills = {
    technical: [
      { name: "Kotlin (Android)", level: 95 },
      { name: "Dart (Flutter)", level: 90 },
      { name: "Java Spring Boot", level: 85 },
      { name: "Jetpack Compose", level: 90 },
      { name: "Firebase", level: 85 },
      { name: "Room / SQL", level: 80 },
      { name: "Retrofit / API", level: 85 },
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <p className="text-base md:text-lg font-medium leading-relaxed">
                  Recent ICT Graduate actively seeking a Mobile Development position. Passionate about building robust Android and Cross-Platform applications using Kotlin and Flutter, with a strong foundation in backend integration.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm md:text-base">Graduated: Dec 2025</p>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-lg mb-6 leading-relaxed">
                I'm actively seeking Mobile Development opportunities (Android/Flutter). Let's build something amazing
              ...
              <div className="space-y-4">
                <div className="bg-yellow-400 text-black p-4 border-2 border-white hover:scale-105 transition-transform duration-300">
                  ...
                  <div>Open for Mobile Development Roles</div>
                </div>
                <div className="bg-yellow-400 text-black p-4 border-2 border-white hover:scale-105 transition-transform duration-300">
                  <div className="font-bold">SPECIALIZATION</div>
                  <div>Native Android (Kotlin) & Flutter</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <p className="font-bold">© 2025 Tashi Namgyel. Built with Passion & Code.</p>
            </div>
